...
Used by `hledger-preprocessor` extends `hledger-flow`. Visualises your financial
situation using hledger journals that use double-entry bookkeeping/accounting.
